...
export const EstimateTables: React.FC<EstimateTablesProps> = ({
  ...
  const actualProfit = roofValues.contractPrice.value - (
    operationalExpenses + 
    (totals.sipWalls || 0) + // Стоимость СИП панелей
    (roofValues.metalTileArea.value * roofValues.metalTileArea.price || 0) + // Стоимость металлочерепицы
    (salaryTotal || 0) // Общая сумма ЗП
  );
        ...
        <div className="bg-purple-100 p-3 rounded-lg shadow">
          <div className="flex justify-between items-center">
            <span className="font-bold text-purple-800">
              Прибыль компании на данный момент после всех фактических расходов составляет:
            </span>
            <span className="font-bold text-purple-800">
